...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CompetitorCompanion.Android.dll" comes first in this list. */
		"CompetitorCompanion.Android.dll",
		"FormsControls.Base.dll",
		"FormsControls.Droid.dll",
		"FormsViewGroup.dll",
		"IPSCCompanionApp.dll",
		"IPSCCompanionLibrary.dll",
		"Newtonsoft.Json.dll",
